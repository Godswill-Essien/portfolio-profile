    ...
    >
      ...
      >
        ...
        <div data-aos="fade-down" className="relative w-full h-full rounded-2xl overflow-hidden bg-black/20 backdrop-blur-xl border border-white/10 shadow-2xl hover:shadow-3xl transition-shadow duration-500">
          <Image
            ...
            fill
            priority
            className="object-cover transition-transform duration-700 opacity-80 hover:opacity-100 dark:opacity-100 hover:scale-110"
      ...
      >
        ...
        <div data-aos="fade-up" className="flex flex-col gap-4">
          ...
          <p className="px-6 py-5 rounded-3xl bg-white/5 md:hover:scale-110 transition-all duration-1000  ease-in-out backdrop-blur-3xl border dark:border-black dark:text-black  border-white/20 shadow-lg text-gray-200  hover:shadow-2xl">
