...
export default function Foter() {
    return (
        <footer className=" rounded-2xl backdrop-blur-3xl text-white font-serif py-8 px-4 sm:px-10 mt-14 shadow-2xl relative overflow-hidden">
            {/* Decorative circles */}
            <div className="absolute -top-10 -left-10 w-24 h-24 sm:w-32 sm:h-32 bg-blue-700 opacity-20 rounded-full animate-pulse"></div>
            <div className="absolute -bottom-10 -right-10 w-32 h-32 sm:w-40 sm:h-40 bg-blue-700  opacity-15 rounded-full animate-pulse"></div>

            <div className="flex flex-col justify-center items-center gap-3">
                <p className="opacity-100 text-center text-[18px] sm:text-[27px] font-bold bg-gradient-to-r from-blue-800 to-indigo-800 bg-clip-text text-transparent ">
            ...
            <div className="flex flex-col items-center justify-center gap- mt-6 rounded-lg w-full">
                <div className="flex gap-4 sm:gap-5 flex-wrap justify-center w-full">
                    <div className="shadow-2xl shadow-blue-900 transition-all rounded-md duration-500 ease-in-out hover:-translate-y-1 py-2 px-6 bg-gradient-to-r from-blue-800 to-indigo-900">
                        <Link href="mailto:godswillessien880@gmail.com" className="text-[16px] sm:text-[20px] font-semibold">
                            Reach Me
                        </Link>
                    </div>

                    <div className="shadow-2xl  shadow-blue-900 transition-all duration-500 ease-in-out hover:-translate-y-1 py-2 px-4 rounded-full bg-gradient-to-r from-blue-800 to-indigo-900 flex items-center justify-center">
                ...
                <p className="mt-4 text-xs sm:text-sm text-white/60">&copy; {new Date().getFullYear()} Portfolio. All rights reserved.</p>
