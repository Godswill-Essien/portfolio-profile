            ...
            <div className="relative z-20 overflow-hidden">
                ...
                <div className='md:hidden lg:hidden sm:hidden'>
                    <div className='flex flex-col items-center justify-center mt-16 gap-5'>
                        <div className='bg-gradient-to-r from-green-700 via-red-700 to-blue-700 animate-gradient p-[2px] max-w-[500px] rounded-full w-[250px] h-[250px] flex items-center justify-center transition-all duration-500 ease-in-out hover:translate-y-[-3px]'>
                        ...
                        <div className='w-full flex justify-center mb-6'>
                            <a
                                ...
                                download
                                className='bg-black border rounded-3xl transition-all duration-500 hover:scale-105 py-2 px-6 '>
                                Download CV
                            </a>
                        </div>
                    </div>
                ...
                {/* desktop */}
                <div className='hidden mt-28 md:block lg:block'>
                    <div className='flex flex-col items-center justify-center mt-16 gap-5'>
                        <div data-aos="fade-down" className='bg-gradient-to-r from-blue-900 to-indigo-900 rounded-full w-[300px] h-[300px] flex items-center justify-center transition-all duration-500 ease-in-out hover:translate-y-[-3px]'>
                            <div className='bg-black rounded-full w-[295px] h-[295px] flex items-center justify-center hover:bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent'>
                                <div className='hover:opacity-80'>
                        ...
                        <div className='shadow-2xl  bg-black  transition-all duration-500 ease-in-out hover:translate-y-[-4px] py-1 px-5 rounded-2xl border'>
