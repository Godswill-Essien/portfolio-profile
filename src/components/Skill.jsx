...
export default function TextImageComponent() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 mt- flex    flex-col md:flex-row-reverse items-stretch   md:py-6 md:bg-w-full  gap-8">
      ...
      {/* Image Section */}
      <div data-aos="fade-down" id="cert" className="flex-shrink-0  w-full md:w-1/2 h-full md:mt-20  px-3 py-2 rounded-xl  bg-gradient-to-r from-gray-900/50 via-blue-800/40 to-red-700/50 animate-gradient">

        <img
          src={content.imageUrl || "/cert.jpg"}
          alt="Template"
          className="rounded-xl shadow-xl w-full h-full object-cover hover:cursor-pointer opacity-10 hover:opacity-100  transition-all duration-1000 ease-in-out 
                         hover:scale-110 "
        />
